          ...
          <div style={{
            ...
            {report.findings.map(f => (
              <div key={f.angle} style={{
                ...
                background: f.confidence === 'high' ? '#14532d22' : f.confidence === 'medium' ? '#78350f22' : '#1e293b',
                border: `1px solid ${f.confidence === 'high' ? '#166534' : f.confidence === 'medium' ? '#92400e' : '#334155'}`,
                color: f.confidence === 'high' ? '#4ade80' : f.confidence === 'medium' ? '#fbbf24' : '#64748b',
              }}>
